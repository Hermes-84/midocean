...
FILENAME = "general.csv"  # allineato con augment_general.py
...
def main():
    ...
    for master in products:
        ...
        # carton / packaging dal master (se assenti, resteranno vuoti)
        ...
        for v in variants:
            ...
            row = {
                ...
                "products__product__net_weight": "",     # riempito da augment_general.py
                "products__product__gross_weight": "",   # riempito da augment_general.py
